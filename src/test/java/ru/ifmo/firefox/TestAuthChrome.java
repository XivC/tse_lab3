...
public class TestAuthChrome {
  ...
  private TestAuthChrome toGenderPage() throws InterruptedException {
  ...
  private TestAuthChrome toPurposePage() throws InterruptedException {
    driver.findElement(new By.ByXPath("/html/body/div[2]/div[1]/div[2]/main/div/div/main/div[1]/div/button")).click();
    Thread.sleep(2000);
    return this;
  }

  private TestAuthChrome toHeightPage() throws InterruptedException {
    driver.findElement(new By.ByXPath("/html/body/div[2]/div[1]/div[2]/main/div/div/main/div[2]/div/button")).click();
    Thread.sleep(2000);
    return this;
  }

  private TestAuthChrome toWeightPage() throws InterruptedException {
    driver.findElement(new By.ByXPath("/html/body/div[2]/div[1]/div[2]/main/div/div/main/div[2]/div/button")).click();
    Thread.sleep(2000);
    return this;
  }

  private TestAuthChrome toNamePage() throws InterruptedException {
    driver.findElement(new By.ByXPath("/html/body/div[2]/div[1]/div[2]/main/div/div/main/div[2]/div/button")).click();
    Thread.sleep(3000);
    return this;
  }

  private TestAuthChrome toAgePage(String name) throws InterruptedException{
